...
window.addEventListener("load",loadLaunches)                        // This event listener calls the loadPage function on load
    ...
    for(let i = 0; i < row.length; i++)             // starts at first value of table 
{
  ...
  // this sets launchrows to the array myRows.  Ultimatley gives launchRows an array to compare to
}
